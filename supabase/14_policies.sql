-- 14_policies.sql
-- Source: Supabase POLICIES.txt
-- Last sync: (Current)
-- DO NOT EDIT MANUALLY

DROP POLICY IF EXISTS "Users can see anomalies in their tenant" ON "public"."ai_anomaly_logs";
CREATE POLICY "Users can see anomalies in their tenant" ON "public"."ai_anomaly_logs" AS PERMISSIVE FOR SELECT TO authenticated USING (EXISTS ( SELECT 1
FROM profiles
...
CREATE POLICY "superadmin_delete" ON "public"."ai_anomaly_logs" AS PERMISSIVE FOR DELETE TO authenticated USING (EXISTS ( SELECT 1
FROM profiles
...
CREATE POLICY "ai_conversations_delete" ON "public"."ai_conversations" AS PERMISSIVE FOR DELETE TO authenticated USING (profile_id IN ( SELECT profiles.id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "ai_conversations_insert" ON "public"."ai_conversations";
CREATE POLICY "ai_conversations_insert" ON "public"."ai_conversations" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (profile_id IN ( SELECT profiles.id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "ai_conversations_select" ON "public"."ai_conversations";
CREATE POLICY "ai_conversations_select" ON "public"."ai_conversations" AS PERMISSIVE FOR SELECT TO authenticated USING (profile_id IN ( SELECT profiles.id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "ai_conversations_update" ON "public"."ai_conversations";
CREATE POLICY "ai_conversations_update" ON "public"."ai_conversations" AS PERMISSIVE FOR UPDATE TO authenticated USING (profile_id IN ( SELECT profiles.id
FROM profiles
...
CREATE POLICY "ai_pending_entries_delete" ON "public"."ai_pending_entries" AS PERMISSIVE FOR DELETE TO authenticated USING (profile_id IN ( SELECT profiles.id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "ai_pending_entries_insert" ON "public"."ai_pending_entries";
CREATE POLICY "ai_pending_entries_insert" ON "public"."ai_pending_entries" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (profile_id IN ( SELECT profiles.id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "ai_pending_entries_select" ON "public"."ai_pending_entries";
CREATE POLICY "ai_pending_entries_select" ON "public"."ai_pending_entries" AS PERMISSIVE FOR SELECT TO authenticated USING (profile_id IN ( SELECT profiles.id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "ai_pending_entries_update" ON "public"."ai_pending_entries";
CREATE POLICY "ai_pending_entries_update" ON "public"."ai_pending_entries" AS PERMISSIVE FOR UPDATE TO authenticated USING (profile_id IN ( SELECT profiles.id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid()))) WITH CHECK (profile_id IN ( SELECT profiles.id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));
...
CREATE POLICY "superadmin_delete" ON "public"."ai_staged_transactions" AS PERMISSIVE FOR DELETE TO authenticated USING (EXISTS ( SELECT 1
FROM profiles
WHERE ((profiles.auth_user_id = auth.uid()) AND (profiles.role = 'superadmin'::text))));
...
CREATE POLICY "Target can respond to connection" ON "public"."broker_connections" AS PERMISSIVE FOR UPDATE TO authenticated USING ((target_tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
...
CREATE POLICY "Tenant can request connection" ON "public"."broker_connections" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (requester_tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "Tenant can view own connections" ON "public"."broker_connections";
CREATE POLICY "Tenant can view own connections" ON "public"."broker_connections" AS PERMISSIVE FOR SELECT TO authenticated USING ((requester_tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
...
CREATE POLICY "superadmin_delete" ON "public"."broker_profiles" AS PERMISSIVE FOR DELETE TO authenticated USING (EXISTS ( SELECT 1
FROM profiles
WHERE ((profiles.auth_user_id = auth.uid()) AND (profiles.role = 'superadmin'::text))));
...
CREATE POLICY "deliveries_insert" ON "public"."deliveries" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (EXISTS ( SELECT 1
FROM profiles p
WHERE ((p.auth_user_id = auth.uid()) AND (p.tenant_id = deliveries.tenant_id))));

DROP POLICY IF EXISTS "deliveries_select" ON "public"."deliveries";
CREATE POLICY "deliveries_select" ON "public"."deliveries" AS PERMISSIVE FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
FROM profiles p
WHERE ((p.auth_user_id = auth.uid()) AND (p.tenant_id = deliveries.tenant_id)))) OR is_superadmin());

DROP POLICY IF EXISTS "deliveries_update" ON "public"."deliveries";
CREATE POLICY "deliveries_update" ON "public"."deliveries" AS PERMISSIVE FOR UPDATE TO authenticated USING ((EXISTS ( SELECT 1
FROM profiles p
WHERE ((p.auth_user_id = auth.uid()) AND (p.tenant_id = deliveries.tenant_id)))) OR is_superadmin()) WITH CHECK ((EXISTS ( SELECT 1
FROM profiles p
WHERE ((p.auth_user_id = auth.uid()) AND (p.tenant_id = deliveries.tenant_id)))) OR is_superadmin());
...
CREATE POLICY "drivers_insert" ON "public"."drivers" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (((EXISTS ( SELECT 1
FROM profiles p
...
CREATE POLICY "drivers_select" ON "public"."drivers" AS PERMISSIVE FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
FROM profiles p
WHERE ((p.auth_user_id = auth.uid()) AND (p.tenant_id = drivers.tenant_id)))) OR is_superadmin());

DROP POLICY IF EXISTS "drivers_update" ON "public"."drivers";
CREATE POLICY "drivers_update" ON "public"."drivers" AS PERMISSIVE FOR UPDATE TO authenticated USING (((EXISTS ( SELECT 1
FROM profiles p
WHERE ((p.auth_user_id = auth.uid()) AND (p.tenant_id = drivers.tenant_id)))) AND can_manage_drivers(tenant_id)) OR is_superadmin()) WITH CHECK (((EXISTS ( SELECT 1
FROM profiles p
WHERE ((p.auth_user_id = auth.uid()) AND (p.tenant_id = drivers.tenant_id)))) AND can_manage_drivers(tenant_id)) OR is_superadmin());
...
CREATE POLICY "egg_sale_items_tenant_isolation" ON "public"."egg_sale_items" AS PERMISSIVE FOR ALL TO authenticated USING (is_superadmin() OR (EXISTS ( SELECT 1
FROM egg_sales
WHERE ((egg_sales.id = egg_sale_items.sale_id) AND is_tenant_member(egg_sales.tenant_id))))) WITH CHECK (is_superadmin() OR (EXISTS ( SELECT 1
FROM egg_sales
WHERE ((egg_sales.id = egg_sale_items.sale_id) AND is_tenant_member(egg_sales.tenant_id) AND (my_role_for(egg_sales.tenant_id) = ANY (ARRAY['owner'::text, 'admin'::text, 'sales'::text, 'gudang'::text]))))));
...
CREATE POLICY "loss_reports_insert" ON "public"."loss_reports" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (EXISTS ( SELECT 1
FROM profiles p
...
CREATE POLICY "loss_reports_select" ON "public"."loss_reports" AS PERMISSIVE FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
FROM profiles p
WHERE ((p.auth_user_id = auth.uid()) AND (p.tenant_id = loss_reports.tenant_id)))) OR is_superadmin());

DROP POLICY IF EXISTS "loss_reports_update" ON "public"."loss_reports";
CREATE POLICY "loss_reports_update" ON "public"."loss_reports" AS PERMISSIVE FOR UPDATE TO authenticated USING ((EXISTS ( SELECT 1
FROM profiles p
WHERE ((p.auth_user_id = auth.uid()) AND (p.tenant_id = loss_reports.tenant_id)))) OR is_superadmin()) WITH CHECK ((EXISTS ( SELECT 1
FROM profiles p
WHERE ((p.auth_user_id = auth.uid()) AND (p.tenant_id = loss_reports.tenant_id)))) OR is_superadmin());
...
FROM profiles p
WHERE ((p.auth_user_id = auth.uid()) AND (p.tenant_id = payments.tenant_id)))) OR is_superadmin());
...
CREATE POLICY "profiles_owner_manage_team" ON "public"."profiles" AS PERMISSIVE FOR UPDATE TO authenticated USING (EXISTS ( SELECT 1
FROM profiles me
WHERE ((me.auth_user_id = auth.uid()) AND (me.tenant_id = profiles.tenant_id) AND (me.role = ANY (ARRAY['owner'::text, 'admin'::text, 'manajer'::text, 'manager'::text]))))) WITH CHECK ((tenant_id = ANY (auth_user_tenant_ids())) AND (role <> 'superadmin'::text));
...
CREATE POLICY "purchases_insert" ON "public"."purchases" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (((EXISTS ( SELECT 1
FROM profiles p
...
CREATE POLICY "purchases_select" ON "public"."purchases" AS PERMISSIVE FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
FROM profiles p
WHERE ((p.auth_user_id = auth.uid()) AND (p.tenant_id = purchases.tenant_id)))) OR is_superadmin());

DROP POLICY IF EXISTS "purchases_update" ON "public"."purchases";
CREATE POLICY "purchases_update" ON "public"."purchases" AS PERMISSIVE FOR UPDATE TO authenticated USING (((EXISTS ( SELECT 1
FROM profiles p
WHERE ((p.auth_user_id = auth.uid()) AND (p.tenant_id = purchases.tenant_id)))) AND can_update_purchases(tenant_id)) OR is_superadmin()) WITH CHECK (((EXISTS ( SELECT 1
FROM profiles p
WHERE ((p.auth_user_id = auth.uid()) AND (p.tenant_id = purchases.tenant_id)))) AND can_update_purchases(tenant_id)) OR is_superadmin());
...
CREATE POLICY "rpa_invoice_items_delete" ON "public"."rpa_invoice_items" AS PERMISSIVE FOR DELETE TO authenticated USING (EXISTS ( SELECT 1
FROM rpa_invoices i
WHERE ((i.id = rpa_invoice_items.invoice_id) AND ((is_tenant_member(i.tenant_id) AND (my_role_for(i.tenant_id) = ANY (ARRAY['owner'::text, 'admin_rpa'::text]))) OR is_superadmin()))));

DROP POLICY IF EXISTS "rpa_invoice_items_insert" ON "public"."rpa_invoice_items";
CREATE POLICY "rpa_invoice_items_insert" ON "public"."rpa_invoice_items" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (EXISTS ( SELECT 1
FROM rpa_invoices i
...
CREATE POLICY "rpa_invoice_items_select" ON "public"."rpa_invoice_items" AS PERMISSIVE FOR SELECT TO authenticated USING (EXISTS ( SELECT 1
FROM rpa_invoices i
WHERE ((i.id = rpa_invoice_items.invoice_id) AND ((is_tenant_member(i.tenant_id) AND (my_role_for(i.tenant_id) = ANY (ARRAY['owner'::text, 'admin_rpa'::text]))) OR is_superadmin()))));

DROP POLICY IF EXISTS "rpa_invoice_items_update" ON "public"."rpa_invoice_items";
CREATE POLICY "rpa_invoice_items_update" ON "public"."rpa_invoice_items" AS PERMISSIVE FOR UPDATE TO authenticated USING (EXISTS ( SELECT 1
FROM rpa_invoices i
WHERE ((i.id = rpa_invoice_items.invoice_id) AND ((is_tenant_member(i.tenant_id) AND can_manage_rpa(i.tenant_id)) OR is_superadmin())))) WITH CHECK (EXISTS ( SELECT 1
FROM rpa_invoices i
WHERE ((i.id = rpa_invoice_items.invoice_id) AND ((is_tenant_member(i.tenant_id) AND can_manage_rpa(i.tenant_id)) OR is_superadmin()))));
...
CREATE POLICY "sales_insert" ON "public"."sales" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (((EXISTS ( SELECT 1
FROM profiles p
WHERE ((p.auth_user_id = auth.uid()) AND (p.tenant_id = sales.tenant_id)))) AND can_manage_sales(tenant_id)) OR is_superadmin());

DROP POLICY IF EXISTS "sales_select" ON "public"."sales";
CREATE POLICY "sales_select" ON "public"."sales" AS PERMISSIVE FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
FROM profiles p
WHERE ((p.auth_user_id = auth.uid()) AND (p.tenant_id = sales.tenant_id)))) OR is_superadmin());

DROP POLICY IF EXISTS "sales_update" ON "public"."sales";
CREATE POLICY "sales_update" ON "public"."sales" AS PERMISSIVE FOR UPDATE TO authenticated USING (((EXISTS ( SELECT 1
FROM profiles p
WHERE ((p.auth_user_id = auth.uid()) AND (p.tenant_id = sales.tenant_id)))) AND can_update_sales(tenant_id)) OR is_superadmin()) WITH CHECK (((EXISTS ( SELECT 1
FROM profiles p
WHERE ((p.auth_user_id = auth.uid()) AND (p.tenant_id = sales.tenant_id)))) AND can_update_sales(tenant_id)) OR is_superadmin());

DROP POLICY IF EXISTS "tenant_sapi_breeding_animals_delete" ON "public"."sapi_breeding_animals";
CREATE POLICY "tenant_sapi_breeding_animals_delete" ON "public"."sapi_breeding_animals" AS PERMISSIVE FOR DELETE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_breeding_animals_insert" ON "public"."sapi_breeding_animals";
CREATE POLICY "tenant_sapi_breeding_animals_insert" ON "public"."sapi_breeding_animals" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_breeding_animals_select" ON "public"."sapi_breeding_animals";
CREATE POLICY "tenant_sapi_breeding_animals_select" ON "public"."sapi_breeding_animals" AS PERMISSIVE FOR SELECT TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_breeding_animals_update" ON "public"."sapi_breeding_animals";
CREATE POLICY "tenant_sapi_breeding_animals_update" ON "public"."sapi_breeding_animals" AS PERMISSIVE FOR UPDATE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
...
CREATE POLICY "tenant_sapi_breeding_births_delete" ON "public"."sapi_breeding_births" AS PERMISSIVE FOR DELETE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_breeding_births_insert" ON "public"."sapi_breeding_births";
CREATE POLICY "tenant_sapi_breeding_births_insert" ON "public"."sapi_breeding_births" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_breeding_births_select" ON "public"."sapi_breeding_births";
CREATE POLICY "tenant_sapi_breeding_births_select" ON "public"."sapi_breeding_births" AS PERMISSIVE FOR SELECT TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_breeding_births_update" ON "public"."sapi_breeding_births";
CREATE POLICY "tenant_sapi_breeding_births_update" ON "public"."sapi_breeding_births" AS PERMISSIVE FOR UPDATE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid()))) WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));
...
CREATE POLICY "tenant_sapi_breeding_feed_logs_delete" ON "public"."sapi_breeding_feed_logs" AS PERMISSIVE FOR DELETE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_breeding_feed_logs_insert" ON "public"."sapi_breeding_feed_logs";
CREATE POLICY "tenant_sapi_breeding_feed_logs_insert" ON "public"."sapi_breeding_feed_logs" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_breeding_feed_logs_select" ON "public"."sapi_breeding_feed_logs";
CREATE POLICY "tenant_sapi_breeding_feed_logs_select" ON "public"."sapi_breeding_feed_logs" AS PERMISSIVE FOR SELECT TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_breeding_feed_logs_update" ON "public"."sapi_breeding_feed_logs";
CREATE POLICY "tenant_sapi_breeding_feed_logs_update" ON "public"."sapi_breeding_feed_logs" AS PERMISSIVE FOR UPDATE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid()))) WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));
...
CREATE POLICY "tenant_sapi_breeding_health_logs_delete" ON "public"."sapi_breeding_health_logs" AS PERMISSIVE FOR DELETE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_breeding_health_logs_insert" ON "public"."sapi_breeding_health_logs";
CREATE POLICY "tenant_sapi_breeding_health_logs_insert" ON "public"."sapi_breeding_health_logs" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_breeding_health_logs_select" ON "public"."sapi_breeding_health_logs";
CREATE POLICY "tenant_sapi_breeding_health_logs_select" ON "public"."sapi_breeding_health_logs" AS PERMISSIVE FOR SELECT TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_breeding_health_logs_update" ON "public"."sapi_breeding_health_logs";
CREATE POLICY "tenant_sapi_breeding_health_logs_update" ON "public"."sapi_breeding_health_logs" AS PERMISSIVE FOR UPDATE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid()))) WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));
...
CREATE POLICY "tenant_sapi_breeding_mating_records_delete" ON "public"."sapi_breeding_mating_records" AS PERMISSIVE FOR DELETE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_breeding_mating_records_insert" ON "public"."sapi_breeding_mating_records";
CREATE POLICY "tenant_sapi_breeding_mating_records_insert" ON "public"."sapi_breeding_mating_records" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_breeding_mating_records_select" ON "public"."sapi_breeding_mating_records";
CREATE POLICY "tenant_sapi_breeding_mating_records_select" ON "public"."sapi_breeding_mating_records" AS PERMISSIVE FOR SELECT TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_breeding_mating_records_update" ON "public"."sapi_breeding_mating_records";
CREATE POLICY "tenant_sapi_breeding_mating_records_update" ON "public"."sapi_breeding_mating_records" AS PERMISSIVE FOR UPDATE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid()))) WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));
...
CREATE POLICY "tenant_sapi_breeding_sales_delete" ON "public"."sapi_breeding_sales" AS PERMISSIVE FOR DELETE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_breeding_sales_insert" ON "public"."sapi_breeding_sales";
CREATE POLICY "tenant_sapi_breeding_sales_insert" ON "public"."sapi_breeding_sales" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_breeding_sales_select" ON "public"."sapi_breeding_sales";
CREATE POLICY "tenant_sapi_breeding_sales_select" ON "public"."sapi_breeding_sales" AS PERMISSIVE FOR SELECT TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_breeding_sales_update" ON "public"."sapi_breeding_sales";
CREATE POLICY "tenant_sapi_breeding_sales_update" ON "public"."sapi_breeding_sales" AS PERMISSIVE FOR UPDATE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid()))) WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));
...
CREATE POLICY "tenant_sapi_breeding_weight_records_delete" ON "public"."sapi_breeding_weight_records" AS PERMISSIVE FOR DELETE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_breeding_weight_records_insert" ON "public"."sapi_breeding_weight_records";
CREATE POLICY "tenant_sapi_breeding_weight_records_insert" ON "public"."sapi_breeding_weight_records" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_breeding_weight_records_select" ON "public"."sapi_breeding_weight_records";
CREATE POLICY "tenant_sapi_breeding_weight_records_select" ON "public"."sapi_breeding_weight_records" AS PERMISSIVE FOR SELECT TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_breeding_weight_records_update" ON "public"."sapi_breeding_weight_records";
CREATE POLICY "tenant_sapi_breeding_weight_records_update" ON "public"."sapi_breeding_weight_records" AS PERMISSIVE FOR UPDATE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid()))) WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));
...
CREATE POLICY "tenant_sapi_kandangs_delete" ON "public"."sapi_kandangs" AS PERMISSIVE FOR DELETE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_kandangs_insert" ON "public"."sapi_kandangs";
CREATE POLICY "tenant_sapi_kandangs_insert" ON "public"."sapi_kandangs" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_kandangs_select" ON "public"."sapi_kandangs";
CREATE POLICY "tenant_sapi_kandangs_select" ON "public"."sapi_kandangs" AS PERMISSIVE FOR SELECT TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_kandangs_update" ON "public"."sapi_kandangs";
CREATE POLICY "tenant_sapi_kandangs_update" ON "public"."sapi_kandangs" AS PERMISSIVE FOR UPDATE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid()))) WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));
...
CREATE POLICY "tenant_sapi_penggemukan_animals_delete" ON "public"."sapi_penggemukan_animals" AS PERMISSIVE FOR DELETE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_penggemukan_animals_insert" ON "public"."sapi_penggemukan_animals";
CREATE POLICY "tenant_sapi_penggemukan_animals_insert" ON "public"."sapi_penggemukan_animals" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_penggemukan_animals_select" ON "public"."sapi_penggemukan_animals";
CREATE POLICY "tenant_sapi_penggemukan_animals_select" ON "public"."sapi_penggemukan_animals" AS PERMISSIVE FOR SELECT TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_penggemukan_animals_update" ON "public"."sapi_penggemukan_animals";
CREATE POLICY "tenant_sapi_penggemukan_animals_update" ON "public"."sapi_penggemukan_animals" AS PERMISSIVE FOR UPDATE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid()))) WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));
...
CREATE POLICY "tenant_sapi_penggemukan_batches_delete" ON "public"."sapi_penggemukan_batches" AS PERMISSIVE FOR DELETE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_penggemukan_batches_insert" ON "public"."sapi_penggemukan_batches";
CREATE POLICY "tenant_sapi_penggemukan_batches_insert" ON "public"."sapi_penggemukan_batches" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_penggemukan_batches_select" ON "public"."sapi_penggemukan_batches";
CREATE POLICY "tenant_sapi_penggemukan_batches_select" ON "public"."sapi_penggemukan_batches" AS PERMISSIVE FOR SELECT TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_penggemukan_batches_update" ON "public"."sapi_penggemukan_batches";
CREATE POLICY "tenant_sapi_penggemukan_batches_update" ON "public"."sapi_penggemukan_batches" AS PERMISSIVE FOR UPDATE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid()))) WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));
...
CREATE POLICY "tenant_sapi_penggemukan_feed_logs_delete" ON "public"."sapi_penggemukan_feed_logs" AS PERMISSIVE FOR DELETE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_penggemukan_feed_logs_insert" ON "public"."sapi_penggemukan_feed_logs";
CREATE POLICY "tenant_sapi_penggemukan_feed_logs_insert" ON "public"."sapi_penggemukan_feed_logs" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_penggemukan_feed_logs_select" ON "public"."sapi_penggemukan_feed_logs";
CREATE POLICY "tenant_sapi_penggemukan_feed_logs_select" ON "public"."sapi_penggemukan_feed_logs" AS PERMISSIVE FOR SELECT TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_penggemukan_feed_logs_update" ON "public"."sapi_penggemukan_feed_logs";
CREATE POLICY "tenant_sapi_penggemukan_feed_logs_update" ON "public"."sapi_penggemukan_feed_logs" AS PERMISSIVE FOR UPDATE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid()))) WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));
...
CREATE POLICY "tenant_sapi_penggemukan_health_logs_delete" ON "public"."sapi_penggemukan_health_logs" AS PERMISSIVE FOR DELETE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_penggemukan_health_logs_insert" ON "public"."sapi_penggemukan_health_logs";
CREATE POLICY "tenant_sapi_penggemukan_health_logs_insert" ON "public"."sapi_penggemukan_health_logs" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_penggemukan_health_logs_select" ON "public"."sapi_penggemukan_health_logs";
CREATE POLICY "tenant_sapi_penggemukan_health_logs_select" ON "public"."sapi_penggemukan_health_logs" AS PERMISSIVE FOR SELECT TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_penggemukan_health_logs_update" ON "public"."sapi_penggemukan_health_logs";
CREATE POLICY "tenant_sapi_penggemukan_health_logs_update" ON "public"."sapi_penggemukan_health_logs" AS PERMISSIVE FOR UPDATE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid()))) WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));
...
CREATE POLICY "tenant_sapi_penggemukan_sales_delete" ON "public"."sapi_penggemukan_sales" AS PERMISSIVE FOR DELETE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_penggemukan_sales_insert" ON "public"."sapi_penggemukan_sales";
CREATE POLICY "tenant_sapi_penggemukan_sales_insert" ON "public"."sapi_penggemukan_sales" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_penggemukan_sales_select" ON "public"."sapi_penggemukan_sales";
CREATE POLICY "tenant_sapi_penggemukan_sales_select" ON "public"."sapi_penggemukan_sales" AS PERMISSIVE FOR SELECT TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_penggemukan_sales_update" ON "public"."sapi_penggemukan_sales";
CREATE POLICY "tenant_sapi_penggemukan_sales_update" ON "public"."sapi_penggemukan_sales" AS PERMISSIVE FOR UPDATE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid()))) WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));
...
CREATE POLICY "tenant_sapi_penggemukan_weight_records_delete" ON "public"."sapi_penggemukan_weight_records" AS PERMISSIVE FOR DELETE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_penggemukan_weight_records_insert" ON "public"."sapi_penggemukan_weight_records";
CREATE POLICY "tenant_sapi_penggemukan_weight_records_insert" ON "public"."sapi_penggemukan_weight_records" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_penggemukan_weight_records_select" ON "public"."sapi_penggemukan_weight_records";
CREATE POLICY "tenant_sapi_penggemukan_weight_records_select" ON "public"."sapi_penggemukan_weight_records" AS PERMISSIVE FOR SELECT TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));

DROP POLICY IF EXISTS "tenant_sapi_penggemukan_weight_records_update" ON "public"."sapi_penggemukan_weight_records";
CREATE POLICY "tenant_sapi_penggemukan_weight_records_update" ON "public"."sapi_penggemukan_weight_records" AS PERMISSIVE FOR UPDATE TO authenticated USING (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid()))) WITH CHECK (tenant_id IN ( SELECT profiles.tenant_id
FROM profiles
WHERE (profiles.auth_user_id = auth.uid())));
...
CREATE POLICY "sembako_sale_items_all" ON "public"."sembako_sale_items" AS PERMISSIVE FOR ALL TO authenticated USING (is_superadmin() OR (EXISTS ( SELECT 1
FROM sembako_sales
WHERE ((sembako_sales.id = sembako_sale_items.sale_id) AND is_tenant_member(sembako_sales.tenant_id))))) WITH CHECK (is_superadmin() OR (EXISTS ( SELECT 1
FROM sembako_sales
WHERE ((sembako_sales.id = sembako_sale_items.sale_id) AND is_tenant_member(sembako_sales.tenant_id) AND (my_role_for(sembako_sales.tenant_id) = ANY (ARRAY['owner'::text, 'admin'::text, 'sales'::text, 'gudang'::text]))))));
...
CREATE POLICY "listings_select" ON "public"."stock_listings" AS PERMISSIVE FOR SELECT TO authenticated USING (is_tenant_member(peternak_tenant_id) OR (visible_to = 'public'::text) OR is_superadmin() OR ((visible_to = 'connected'::text) AND (EXISTS ( SELECT 1
FROM broker_connections bc
WHERE ((bc.status = 'active'::text) AND (((bc.requester_tenant_id = stock_listings.peternak_tenant_id) AND is_tenant_member(bc.target_tenant_id)) OR (is_tenant_member(bc.requester_tenant_id) AND (bc.target_tenant_id = stock_listings.peternak_tenant_id))))))));
...
CREATE POLICY "memberships_insert_via_invite" ON "public"."tenant_memberships" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK ((auth_user_id = auth.uid()) AND ((EXISTS ( SELECT 1
...
CREATE POLICY "tenants_user_select" ON "public"."tenants" AS PERMISSIVE FOR SELECT TO authenticated USING (EXISTS ( SELECT 1
FROM profiles p
WHERE ((p.tenant_id = tenants.id) AND (p.auth_user_id = auth.uid()))));
