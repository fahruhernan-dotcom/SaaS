...
const STATUS_CONFIG = {
  ...
  confirmed: { label: 'Dikonfirmasi', color: '#10B981', bg: 'rgba(16, 185, 129, 0.15)', icon: CheckCircle2 },
  in_delivery: { label: 'Dikirim', color: '#A78BFA', bg: 'rgba(167,139,250,0.12)', icon: Truck },
  delivered: { label: 'Terkirim', color: '#10B981', bg: 'rgba(16, 185, 129, 0.15)', icon: Truck },
