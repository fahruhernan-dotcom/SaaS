...
// ── SAPI BREEDING SPECIFIC CONFIG ─────────────────────────────────────────────

const SAPI_BREEDING_HOOKS = {
  useAnimals: useSapiBreedingAnimals,
  useAddWeight: useAddSapiBreedingWeightRecord,
  // Breeding typically doesn't use batches in the same way as fattening
  useBatches: () => ({ data: [], isLoading: false }), 
  useActiveBatches: () => ({ data: [], isLoading: false }),
  useAddHealth: useAddSapiBreedingHealthLog,
  useAddFeed: useAddSapiBreedingFeedLog,
  weightTable: 'sapi_breeding_weight_records'
}
...
export default function SapiBreedingDailyTask() {
