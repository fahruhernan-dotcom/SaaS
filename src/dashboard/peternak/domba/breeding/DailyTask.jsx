...
// ── DOMBA BREEDING SPECIFIC CONFIG ─────────────────────────────────────────────

const DOMBA_BREEDING_HOOKS = {
  ...
  useAddFeed: useAddDombaBreedingFeedLog,
  weightTable: 'domba_breeding_weight_records'
}
...
export default function DombaBreedingDailyTask() {
  const livestockType = 'domba_breeding'
