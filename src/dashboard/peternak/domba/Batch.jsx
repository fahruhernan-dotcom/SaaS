...
import {
  useDombaBatches, useCreateDombaBatch, useCloseDombaBatch,
...
export default function DombaPenggemukanBatch() {
  const navigate = useNavigate()
  const { data: allBatches = [], isLoading } = useDombaBatches()
  const createBatch = useCreateDombaBatch()
