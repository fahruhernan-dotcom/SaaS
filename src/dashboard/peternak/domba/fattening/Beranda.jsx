...
export default function DombaPenggemukanBeranda() {
  ...
  return (
    <div className="text-slate-100 pb-28">
      ...
      {isMobile ? (
        <div className="pb-24">
          <MobileHeader title="Fattening Domba" />
          ...
          <div className="space-y-7 relative z-20 pt-4">
              ...
              <div>
                ...
                <div className="px-5">
                  <div className="rounded-2xl overflow-hidden border border-white/[0.06] bg-black/20">
                    <KandangMiniMap batchIds={activeBatches.map(b => b.id)} className="min-h-[320px] sm:min-h-[400px] border-none bg-transparent" />
                  </div>
                </div>
              </div>
            )}
            ...
            <div>
              ...
              <div className="px-5">
                <MobileQuickActions
                  onAction={(key) => {
                    if (key === 'timbang') navigate(`${BASE}/input-harian`)
                    else if (key === 'pakan') navigate(`${BASE}/input-harian`)
                    else if (key === 'sehat') navigate(`${BASE}/kesehatan`)
                    else if (key === 'catatan') navigate(`${BASE}/catatan`)
                  }}
                />
              </div>
            </div>
