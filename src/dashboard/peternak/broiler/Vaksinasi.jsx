          ...
          <>
            ...
            <div className="bg-[#111C24] border border-white/[0.08] rounded-2xl p-4">
              ...
              <div className="flex gap-2 flex-wrap">
                <StatusChip count={doneCount}    label="Selesai"  color="#10B981" bg="rgba(16, 185, 129, 0.08)"   border="rgba(16, 185, 129, 0.2)" />
...
function ScheduleCard({ schedule, isLast, onLog, canCatat = true }) {
  ...
  const statusCfg = {
    done:     { label: 'Selesai ✓',     bg: 'rgba(16, 185, 129, 0.08)',   border: 'rgba(16, 185, 129, 0.25)',   dot: '#10B981', text: 'text-emerald-400' },
