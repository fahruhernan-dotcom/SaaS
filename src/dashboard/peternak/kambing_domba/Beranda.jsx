...
import {
  useKdActiveBatches, useKdBatches,
...
export default function KdPenggemukanBeranda() {
  const { profile } = useAuth()
  const navigate = useNavigate()

  const { data: activeBatches = [], isLoading: loadingActive } = useKdActiveBatches()
  const { data: allBatches = [], isLoading: loadingAll } = useKdBatches()
