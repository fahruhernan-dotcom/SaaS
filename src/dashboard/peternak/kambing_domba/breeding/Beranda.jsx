...
const BASE = '/peternak/peternak_kambing_domba_breeding'
...
export default function BreedingBeranda() {
  ...
  const { data: animals = [], isLoading: loadingAnimals } = useKdBreedingAnimals()
  const { data: matings = [], isLoading: loadingMatings } = useKdBreedingMatings()
  const { data: births = [] } = useKdBreedingBirths()
