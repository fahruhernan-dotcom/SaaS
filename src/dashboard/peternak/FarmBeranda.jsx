...
function ActiveCycleSection({ cycle, farmId, navigate }) {
    ...
    >
      ...
      <div className="flex gap-2 mt-3.5">
        <button
          ...
          onClick={() => navigate(`/peternak/kandang/${farmId}/input?cycle=${cycle.id}`)}
        >
        ...
        <button
          ...
          onClick={() => navigate(`/peternak/kandang/${farmId}/siklus`)}
        >
          <BarChart2 size={13} />
          Detail Siklus
        </button>
...
export default function FarmBeranda() {
  ...
  if (!farm) return (
    <div className="flex flex-col items-center justify-center min-h-[50vh] p-8 text-center">
      ...
      <button
        onClick={() => navigate('/peternak/beranda')}
  ...
  return (
    <div className="text-slate-100 pb-10">
      ...
      <div className="px-4 mt-4 flex flex-col gap-4">
        ...
        {cycle ? (
          <ActiveCycleSection cycle={cycle} farmId={farmId} navigate={navigate} />
        ) : (
          <motion.div
          ...
          >
            ...
            <button
              ...
              onClick={() => navigate(`/peternak/siklus?action=new&farm=${farmId}`)}
            >
        ...
        <section>
          ...
          <div className="grid grid-cols-3 gap-2.5">
            {[
              { icon: BarChart2,    label: 'Siklus',    path: `/peternak/kandang/${farmId}/siklus`,  color: PURPLE_LIGHT },
              { icon: ClipboardList,label: 'Input',     path: `/peternak/kandang/${farmId}/input`,   color: '#34D399' },
              { icon: Package,      label: 'Pakan',     path: `/peternak/kandang/${farmId}/pakan`,   color: '#60A5FA' },
