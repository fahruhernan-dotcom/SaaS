...
import {
  useKambingBatches, useKambingFeedLogs, useAddKambingFeedLog,
...
export default function KdPenggemukanPakan() {
  ...
  const { data: feedLogs = [], isLoading: loadingLogs } = useKambingFeedLogs(selectedBatch)
  const addFeedLog = useAddKambingFeedLog()
