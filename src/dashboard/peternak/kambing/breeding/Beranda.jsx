...
const BASE = '/peternak/peternak_kambing_breeding'
...
export default function BreedingBeranda() {
  ...
  const { data: animals = [], isLoading: loadingAnimals } = useKambingBreedingAnimals()
  const { data: matings = [], isLoading: loadingMatings } = useKambingBreedingMatings()
  const { data: births = [] } = useKambingBreedingBirths()
