...
import {
  useKambingBatches, useKambingAnimals,
  useAddKambingAnimal, useAddKambingWeightRecord,
...
export default function KdPenggemukanTernak() {
  ...
  const addAnimal = useAddKambingAnimal()
  const addWeight = useAddKambingWeightRecord()
