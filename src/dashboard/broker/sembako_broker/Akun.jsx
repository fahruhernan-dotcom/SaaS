...
import { 
  ...
  HelpCircle, LogOut, CreditCard, 
  ShieldCheck, Settings, Store,
...
export default function SembakoAkun() {
  ...
  return (
    ...
    >
            ...
            <Card className="bg-gradient-to-b from-[#111C24] to-[#0C1319] border-white/5 rounded-[32px] overflow-hidden shadow-2xl relative">
              ...
              <CardContent className="p-7">
                <div className="flex items-center gap-5">
                   <div className="w-20 h-20 rounded-[22px] bg-[#EA580C]/10 border border-[#EA580C]/20 flex items-center justify-center font-display text-3xl font-black text-[#EA580C] shadow-inner relative overflow-hidden group">
                      <div className="absolute inset-0 bg-gradient-to-tr from-[#EA580C]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                      {initials}
                   </div>
                   <div className="flex-1 min-w-0">
                      ...
                      <Badge className="bg-[#EA580C]/10 text-[#EA580C] border border-[#EA580C]/20 font-black text-[9px] px-3 h-6 uppercase tracking-widest">
      ...
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="space-y-8 mt-8 pb-10 max-w-2xl mx-auto"
      >
        ...
        <motion.div variants={fadeUp} className="px-5 space-y-3">
          ...
          <Card className="bg-[#111C24] border-white/5 rounded-[28px] p-6 space-y-5">
              ...
              <Button
                ...
                className="w-full h-14 bg-[#EA580C] hover:bg-[#D44E0A] text-white font-black text-[11px] uppercase tracking-[0.2em] gap-3 rounded-[20px] border-none shadow-[0_8px_30px_rgba(234,88,12,0.15)] active:scale-95 transition-all mt-2"
              >
        ...
        <motion.div variants={fadeUp} className="px-5 space-y-3">
          ...
          <Card className="bg-[#111C24] border-white/5 rounded-[22px] p-4 flex items-center gap-4 group hover:border-white/10 transition-all active:scale-[0.98]">
              <div className="w-12 h-12 rounded-[14px] bg-secondary/15 flex items-center justify-center text-2xl shadow-inner border border-white/5 group-hover:bg-[#EA580C]/10 transition-colors">
                🛒
              </div>
              <div className="flex-1">
                 <p className="text-xs font-black text-white uppercase tracking-wider leading-none mb-1.5">Distributor Sembako</p>
        ...
        <motion.footer variants={fadeUp} className="text-center pt-6 opacity-40">
            <p className="text-[9px] text-[#4B6478] font-black uppercase tracking-[0.4em]">
                TernakOS v2.0.0 • SEMBAKO EDITION
            </p>
        </motion.footer>
      </motion.div>
...
function MenuItem({ icon: Icon, label, sub, onClick, badge }) {
  return (
    ...
    >
      <div className="w-11 h-11 rounded-[14px] bg-secondary/10 flex items-center justify-center text-[#94A3B8] group-hover:bg-[#EA580C]/10 group-hover:text-[#EA580C] transition-all border border-transparent group-hover:border-[#EA580C]/20">
        <Icon size={20} />
      </div>
      <div className="flex-1">
        <div className="flex items-center gap-2.5">
            <p className="text-[13px] font-black text-white leading-none uppercase tracking-tight group-hover:text-[#EA580C] transition-colors">{label}</p>
        ...
        <form onSubmit={handleSave} className="space-y-6 pb-12 text-left">
            <div className="space-y-2">
                ...
                <Input 
                    ...
                    className="bg-[#111C24] border-white/10 h-14 font-black rounded-2xl pl-5 focus:border-[#EA580C]/50 transition-all uppercase text-[12px]"
                />
            </div>
            <div className="space-y-2">
                ...
                <div className="relative">
                    ...
                    <Input 
                        ...
                        className="bg-[#111C24] border-white/10 h-14 font-black rounded-2xl pl-12 focus:border-[#EA580C]/50 transition-all uppercase text-[12px]"
                    />
                </div>
            </div>
            <div className="space-y-2">
                ...
                <div className="relative">
                    ...
                    <Input 
                        ...
                        className="bg-[#111C24] border-white/10 h-14 font-black rounded-2xl pl-12 focus:border-[#EA580C]/50 transition-all"
                    />
                </div>
            </div>
            <Button 
                type="submit" 
                className="w-full h-16 bg-[#EA580C] hover:bg-[#D44E0A] text-white font-black text-[12px] uppercase tracking-[0.25em] rounded-[22px] border-none shadow-[0_10px_30px_rgba(234,88,12,0.2)] mt-6 active:scale-95 transition-all"
                disabled={isLoading}
            >
...
function RecycleItem({ item, type, onRestore, onDelete }) {
    ...
    const getIcon = () => {
        if (type === 'sembako_sales') return History
        if (type === 'sembako_products') return Warehouse
        if (type === 'sembako_customers') return Store
        if (type === 'sembako_deliveries') return Truck
        return Trash2
    }
