...
function DeliveryCard({ delivery, onStart, onComplete, highlighted, onShowDetail }) {
                    ...
                    {(() => {
                      ...
                      return (
                        <div className="grid grid-cols-2 gap-y-2">
                          ...
                          <span className="text-[#4B6478] font-bold uppercase">Tanggal</span>
                          <span className="text-white font-black text-right">{fmtDate(delivery.delivery_date)}</span>
                          {items.length > 0 && (
                            <>
