...
import { useCreateSembakoDelivery, useStartSembakoDelivery, useCompleteSembakoDelivery } from '@/lib/hooks/useSembakoData'
...
// ── Timeline ──────────────────────────────────────────────────────────────────
export function SembakoTimeline({ status }) {
...
export function SembakoDeliveryDetailSheet({ delivery, onClose, onRefresh }) {
  ...
  async function handleStart() {
    try { await startDelivery.mutateAsync(delivery.id); onClose() } catch {}
  }
          ...
          <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="rounded-2xl bg-[#111C24] border border-white/5 p-4 space-y-1">
                ...
                <p className="text-sm font-black text-white uppercase">{delivery.vehicle_plate || '—'}</p>
            ...
            <div className="rounded-2xl bg-[#111C24] border border-white/5 p-4">
              <p className="text-[9px] font-black text-[#4B6478] uppercase tracking-widest mb-3">Timeline</p>
      ...
      <AlertDialog open={showConfirm} onOpenChange={setShowConfirm}>
        <AlertDialogContent className="bg-[#0C1319] border border-white/10 rounded-2xl max-w-sm">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-[#4B6478] text-[11px] font-bold uppercase tracking-wider">
              Status akan berubah menjadi Terkirim.
