        ...
        <div className="space-y-0.5">
          ...
          <div className="flex items-center justify-end gap-1">
            {sale.payment_status === 'lunas' ? 
              <span className="text-[9px] font-black text-emerald-400 uppercase">{formatPaymentStatus(sale.payment_status)}</span> : 
              sale.payment_status === 'sebagian' ?
              <span className="text-[9px] font-black text-amber-500 uppercase">{formatPaymentStatus(sale.payment_status)}</span> :
              <span className="text-[9px] font-black text-red-500 uppercase tracking-wider">{formatPaymentStatus(sale.payment_status)}</span>
            }
          </div>
        </div>
      ...
      <div className="space-y-4 bg-white/5 p-5 rounded-2xl border border-white/5">
        <div className="flex justify-between items-start">
          ...
          <div className="text-right">
            ...
            <Badge className={cn(
              "mt-1 uppercase text-[10px] font-black border-none",
