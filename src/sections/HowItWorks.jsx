  ...
  const steps = [
    {
      num: "01",
      title: "Daftar Gratis",
      desc: "Buat akun 30 detik. Pilih role Broker atau Peternak."
    },
    {
      num: "02",
      title: "Setup Bisnis",
      desc: "Tambah kandang rekanan dan daftar RPA pembeli. Sekali setup."
    },
    {
      num: "03",
      title: "Catat & Pantau",
      desc: "Mulai catat transaksi secara digital. Pantau profit dan stok secara real-time."
    }
  ];
    ...
    <section id="cara-kerja" className="bg-[#06090F] section-fade-bottom section-padding">
      <div className="max-w-[1280px] mx-auto overflow-hidden">
        ...
        <div className="relative max-w-[1100px] mx-auto px-4">
          ...
          <div className="flex flex-col lg:flex-row gap-[40px] lg:gap-[0px] relative z-10">
            {steps.map((step, i) => (
              <AnimatedContent 
                key={i} 
                direction="vertical"
