export const BUSINESS_MODELS = {
  sembako_broker: {
    ...
    basePath: '/broker/sembako_broker',
    redirectAfterLogin: '/broker/sembako_broker/beranda',
    fabPath: '/broker/sembako_broker/pos?action=new',
    fabLabel: 'Catat Penjualan',
    bottomNav: [
      { path: '/broker/sembako_broker/beranda',   icon: 'Home',         label: 'Beranda'   },
      { path: '/broker/sembako_broker/pos',       icon: 'ShoppingCart', label: 'Penjualan' },
      { path: '/broker/sembako_broker/gudang',    icon: 'Package',      label: 'Gudang'    },
      { path: '/broker/sembako_broker/produk',    icon: 'LayoutGrid',   label: 'Produk'    },
    ],
    drawerMenu: [
      { path: '/broker/sembako_broker/produk',   icon: 'Package',   label: 'Manajemen Produk' },
      { path: '/broker/sembako_broker/karyawan', icon: 'Users',     label: 'Karyawan'         },
      { path: '/broker/sembako_broker/laporan',  icon: 'BarChart2', label: 'Laporan'          },
      { path: '/broker/sembako_broker/akun',     icon: 'User',      label: 'Akun & Profil'    },
    ],
  },
