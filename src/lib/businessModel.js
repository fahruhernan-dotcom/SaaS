...
export const ANIMAL_GROUPS = [
  ...
  },
  {
    ...
    label: 'Kambing',
    icon: '🐐',
    description: 'Penggemukan, Breeding, atau Kambing Perah.',
...
export const BUSINESS_MODELS = {
  ...
  peternak_domba_penggemukan: {
    ...
    category: 'peternak',
    name: 'Penggemukan Domba',
    label: 'Penggemukan Domba',
    categoryLabel: 'Peternak',
    icon: '🐑',
    description: 'Penggemukan (feedlot) domba. Pantau ADG, FCR, mortalitas, dan laba per ekor per batch.',
    color: '#16A34A',
    themeColor: 'green',
    user_type: 'peternak',
  ...
  peternak_kambing_penggemukan: {
    ...
    category: 'peternak',
    name: 'Penggemukan Kambing',
    label: 'Penggemukan Kambing',
    categoryLabel: 'Peternak',
    icon: '🐐',
    description: 'Penggemukan (feedlot) kambing potong. Pantau ADG, FCR, mortalitas, dan laba per ekor.',
    color: '#16A34A',
    themeColor: 'green',
    user_type: 'peternak',
  ...
  peternak_kambing_domba_penggemukan: {
    ...
    category: 'peternak',
    name: 'Penggemukan Kambing & Domba (Legacy)',
