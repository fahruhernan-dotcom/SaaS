...
export const ANIMAL_GROUPS = [
  ...
  },
  {
    ...
    label: 'Kambing & Domba',
    icon: '🐐',
    description: 'Penggemukan (feedlot) atau Breeding (pembibitan).',
    filter: (model) => model.sub_type?.startsWith('peternak_kambing_domba'),
  },
  {
    key: 'sapi',
    label: 'Sapi',
    icon: '🐄',
    description: 'Sapi potong (penggemukan) atau sapi perah.',
  ...
  },
  {
    ...
    label: 'Babi',
    icon: '🐷',
    description: 'Babi penggemukan atau breeding.',
    comingSoon: true,
...
export const BUSINESS_MODELS = {
  ...
  peternak_sapi_penggemukan: {
    ...
    category: 'peternak',
    name: 'Penggemukan Sapi',
    label: 'Penggemukan Sapi',
    categoryLabel: 'Peternak',
    icon: '🐄',
    description: 'Penggemukan (feedlot) sapi potong. Pantau ADG, berat badan, dan laba per ekor.',
    color: '#D97706',
    themeColor: 'amber',
    user_type: 'peternak',
  ...
  peternak_sapi_breeding: {
    ...
    categoryLabel: 'Peternak',
    icon: '🐂',
    description: 'Pembibitan sapi. Kelola pedigree, reproduksi, dan seleksi bibit unggul.',
    color: '#B45309',
    themeColor: 'amber',
    user_type: 'peternak',
  ...
  peternak_babi_penggemukan: {
    ...
    category: 'peternak',
    name: 'Penggemukan Babi',
    label: 'Penggemukan Babi',
    categoryLabel: 'Peternak',
    icon: '🐷',
...
export const VERTICAL_ALIASES = {
  ...
  'peternak_bebek_pedaging':            'peternak_bebek_pedaging',
  'peternak_bebek_layer':               'peternak_bebek_layer',
  'peternak_sapi_penggemukan':          'peternak_sapi_penggemukan',
  'peternak_sapi_breeding':             'peternak_sapi_breeding',
  'peternak_babi_penggemukan':          'peternak_babi_penggemukan',
  'peternak_babi_breeding':             'peternak_babi_breeding',
