...
const PRICING_DATA = {
  ...
  peternak_sapi_potong: {
    ...
    proFeatures: [
      ...
      '1 jenis ternak included',
      'Add-on: +Rp\u00a099.000/bln per jenis ternak tambahan',
      'Manajemen Fattening & Breeding',
      'Input harian & laporan ADG',
      'Log pakan & kesehatan pedet',
      'Export laporan',
      'Prediksi panen & silsilah ternak',
      'TernakOS Market access',
      'Support via WhatsApp',
    ],
    bizExtras: [
  ...
  peternak_sapi_perah: {
    ...
    proFeatures: [
      ...
      '1 jenis ternak included',
      'Add-on: +Rp\u00a099.000/bln per jenis ternak tambahan',
      'Grafik produksi susu harian',
      'Kesehatan kambing/sapi laktasi',
      'Log kawin IB & siklus',
  ...
  peternak_kambing_domba: {
    ...
    proFeatures: [
      ...
      '1 jenis ternak included',
      'Add-on: +Rp\u00a099.000/bln per jenis ternak tambahan',
      'Manajemen populasi massal (Batch)',
      'Input harian log mortalitas',
      'Efisiensi pakan feedlot otomatis',
      'Export laporan',
      'Prediksi panen AI dasar',
      'TernakOS Market access',
      'Support via WhatsApp',
